     ...
     <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
       ...
       <div className="flex flex-col justify-center h-full">
         ...
         <h2 className="text-4xl sm:text-7xl font-bold text-white">
           I'm a Full Stack Web Developer In training And this is my Portfolio.
         </h2>
         {/* Brief introduction */}
         <p className="text-gray-500 py-4 max-w-md">
            Welcome to  my little corner. This is my little humble  growing portfolio that is just staring off I’m Esmeralda but you can call me esme. 
       ...
       <div>
         ...
         /> */}
         <img
           src= "../assets/purple_flowers-removebg-preview.png"
           alt="my profile"
           className="rounded-2xl mx-auto w-2/3 md:w-full"
         />
